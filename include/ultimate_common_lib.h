...
// Override with -dDATA_QUEUE_SZ=n / -dSTATUS_QUEUE_SZ=n when a caller only
// ever needs small transfers (e.g. a palette push is 50 bytes) and memory
// is tight -- see include/upic_viewer.c's region layout for a real case.
#ifndef DATA_QUEUE_SZ
#define DATA_QUEUE_SZ 512
#endif
#ifndef STATUS_QUEUE_SZ
