...
// This file previously used a separate "lowcode"/"lowdata" region
// ($0200-$0800, the "lowmem" compressed inlay) instead of "main" --
// abandoned 2026-09-09 in favor of relocating part of the picture
// buffer to $E000 instead (see upic_viewer.h), which frees more low
// memory ($1000-$1FFF) more simply and without lowmem's fragility
// (compressed-inlay edge cases, the Ultimate-loader $0801 load-address
// requirement). Back to plain "main" (default code/data) throughout.
#pragma code(code)
#pragma data(data)
